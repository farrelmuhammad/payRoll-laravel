...
class PresenceController extends Controller
{
    ...
    {
        $month = $request->input('month', "12"); // Assuming you've retrieved the month from the request
        ...
        $attendanceData = [
            ['date' => '2023-07-01', 'clock_in' => '08:05', 'clock_out' => '16:00'], // Example normal attendance
            ['date' => '2023-07-02', 'clock_in' => '09:30', 'clock_out' => '16:00'], // Example late arrival
